...
public class Time extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 389067579860652697L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Time\",\"namespace\":\"com.example\",\"fields\":[{\"name\":\"epochMillis\",\"type\":[\"null\",\"long\"],\"default\":null}]}");
  ...
  private java.lang.Long epochMillis;
   ...
   */
  public Time(java.lang.Long epochMillis) {
   ...
   */
  public void setEpochMillis(java.lang.Long value) {
   ...
   */
  public static com.example.Time.Builder newBuilder() {
    return new com.example.Time.Builder();
  }
   ...
   * @return A new Time RecordBuilder
   */
  public static com.example.Time.Builder newBuilder(com.example.Time.Builder other) {
    if (other == null) {
      return new com.example.Time.Builder();
    } else {
      return new com.example.Time.Builder(other);
    }
  }
   ...
   * @return A new Time RecordBuilder
   */
  public static com.example.Time.Builder newBuilder(com.example.Time other) {
    if (other == null) {
      return new com.example.Time.Builder();
    } else {
      return new com.example.Time.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Time>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.Time.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.Time other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.epochMillis)) {
        this.epochMillis = data().deepCopy(fields()[0].schema(), other.epochMillis);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Time.Builder setEpochMillis(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Time.Builder clearEpochMillis() {
      epochMillis = null;
